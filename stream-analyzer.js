        ...
        for (const filePath of filePaths) {
            try {
                if (fs.existsSync(filePath)) {
                    ...
                    const outputFileName = `stream-analysis-${path.basename(filePath, '.json')}.md`;
...
if (import.meta.main) {
    async function main() {
        ...
        console.log('🎯 Stream JSON Analyzer - Using stream-json and stream-chain for streaming analysis\n');
